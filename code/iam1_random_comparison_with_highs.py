...
# June 2026 reproduction note: iam1_original.py is the implementation whose
# iteration counts match the archived May-2025 result logs (the later iam1.py
# counts one extra iteration per run); see verification/validate_netlib_subset.py.
from iam1_original import solve_with_iam1 as iam1_standard
